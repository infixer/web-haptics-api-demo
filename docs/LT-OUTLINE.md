...
**発表者メモ:** 会場の映像だけでは振動は伝わらない。実機を手元で体験してもらうか、触った本人の感想を添える。URLを案内する場合は、実際に公開・動作確認したHTTPSの `/` を使う。ローカルホストは参加者のスマホから開けない。
